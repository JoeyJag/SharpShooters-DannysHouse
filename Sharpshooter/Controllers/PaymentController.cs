            ...
            if (Session["cart"] != "")
            {
                ...
                foreach (var item in cart)
                {
                    ItemLIst.items.Add(new Item()
                    {
                        ...
                        name = item.MenuItem.MenuItemTitle.ToString(),
                        currency = "USD",
                        price = item.MenuItem.MenuItemCost.ToString(),
                        quantity = item.MenuItem.MenuItemQuantity.ToString(), /*cart.RecordId.ToString(),*/
                        sku = "sku"
